...
for node, ip in dev_dic.items():
   ...
   ospf_conf = rest_responce_xml.find('.//protocols/ospf')
   isis_conf = rest_responce_xml.find('.//protocols/isis')
   bgp_conf = rest_responce_xml.find('.//protocols/bgp')
   mpls_conf = rest_responce_xml.find('.//protocols/mpls')
   ...
   check_conf_xpath("OSPF Protocol", ospf_conf)
   check_conf_xpath("ISIS Protocol", isis_conf)
   check_conf_xpath("BGP Protocol", bgp_conf)
   check_conf_xpath("MPLS Protocol", mpls_conf)
